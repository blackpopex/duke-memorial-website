...
<html lang="en">
  <head>
    <title>Duke Memorial | Our History</title>
    <link
      rel="icon"
      type="image/x-icon"
  ...
  <body>
    ...
    <div id="header_hero_container">
      ...
      >
        <div class="container">
          <h1 class="text-primary">Our History</h1>
          <p class="text-primary">
        ...
        <div class="container">
          <div class="flex align-start flex-reverse">
            ...
            <div class="column-right col-70">
              <div class="wrapper">
                <div>
                  <h4 class="text-primary">Our Beginning</h4>
                  <p>
                ...
                <div>
                  <h5 class="text-primary margin-top">2022</h5>
                  <p>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Soluta vel repellat natus dolor, illum alias accusantium.
                    Vel asperiores sit facere.
                ...
                <div>
                  <h5 class="text-primary margin-top">2020</h5>
                  <p>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Soluta vel repellat natus dolor, illum alias accusantium.
                    Vel asperiores sit facere.
                ...
                <div>
                  <h5 class="text-primary margin-top">2019</h5>
                  <p>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Soluta vel repellat natus dolor, illum alias accusantium.
                    Vel asperiores sit facere.
